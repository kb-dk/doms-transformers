...
public class DomsFileEnricherObjectHandler implements ObjectHandler {
    ...
    private FileEnricherConfig config;
    ...
    public DomsFileEnricherObjectHandler(FileEnricherConfig config, CentralWebservice webservice, Map<String, String> checksums)
