...
public class BroadcastMetadataEnricher {
     ...
     * @throws IOException
     */
    public BroadcastMetadataEnricher(DomsConfig config, CentralWebservice webservice, Map<String, String> checksums, String filename) throws JAXBException, IOException, ParseException, URISyntaxException {
        this.config = config;
