...
public class BroadcastMetadataEnricher {
     ...
     * @throws IOException
     */
    public BroadcastMetadataEnricher(FFProbeContainingConfig config, CentralWebservice webservice, Map<String, String> checksums, String filename) throws JAXBException, IOException, ParseException, URISyntaxException {
        this.config = config;
