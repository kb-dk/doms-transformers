...
public class DomsFileEnricherObjectHandlerTest {
    ...
    public void setUp() throws Exception {
        ...
        FFProbeLocationPropertyBasedDomsConfig config = new FFProbeLocationPropertyBasedDomsConfig(new File(Thread.currentThread().getContextClassLoader().getResource("fileenricher.properties").toURI()));
        handler = new DomsFileEnricherObjectHandler(config, webservice,null);
    }
