...
public class DomsFileParser {
    ...
    public static DomsObject parse(String baseName, String line, MuxFileChannelCalculator muxFileChannelCalculator) throws ParseException, FileIgnoredException {
