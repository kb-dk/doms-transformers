...
public class DomsShardMigratorObjectHandler implements ObjectHandler {
    ...
    public void transform(String uuid)
        ...
        try {
            ...
            if(shard.getShardStructure() != null) {
                programStructure = convertShardStructure(shard.getShardStructure());    
            }
    ...
    public ProgramStructure convertShardStructure(ShardStructure shardStructure)   
