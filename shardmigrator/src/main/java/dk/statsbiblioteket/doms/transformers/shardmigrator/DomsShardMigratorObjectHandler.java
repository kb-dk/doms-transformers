        ...
        if(shardMetadata.getShardStructure() != null) {
            ...
            if(shardStructure.getHoles() != null) {
                ...
                for (Hole shardHole : shardStructure.getHoles().getHole()) {
                    ...
                    /*
                     * This ugly hack was approved by kfc.
                     * "http://bitfinder.statsbiblioteket.dk/bart/" should be fetched from the configuration,
                     * but that require a few of the config-thingies to get split into interfaces.
                     * Life sucks, and then you die.
                     */
                    programHole.setFile1UUID(webservice.getFileObjectWithURL("http://bitfinder.statsbiblioteket.dk/bart/" + shardHole.getFilePath1()));
                    programHole.setFile2UUID(webservice.getFileObjectWithURL("http://bitfinder.statsbiblioteket.dk/bart/" + shardHole.getFilePath2()));
            ...
            if(shardStructure.getOverlaps() != null) {
                ...
                for (Overlap shardOverlap : shardStructure.getOverlaps().getOverlap()) {
                     ...
                     * Life sucks, and then you die.
                     */
                    programOverlap.setFile1UUID(webservice.getFileObjectWithURL("http://bitfinder.statsbiblioteket.dk/bart/" + shardOverlap.getFilePath1()));
                    programOverlap.setFile2UUID(webservice.getFileObjectWithURL("http://bitfinder.statsbiblioteket.dk/bart/" + shardOverlap.getFilePath2()));
